	...
	<header id="header">
				...
				<!-- Three -->
					<section id="three" class="wrapper style1 fade-up">
						...
						<?php
						if(isset($_SESSION['nao_autenticados'])):
						...
						unset($_SESSION['nao_autenticados']);
						?>
							...
							<div class="split style1">
								<section>
									...
									<p>
										<h1>Login para funcionário</h1> 
										<p> 
										  <label for="email_login">E-mail</label>
										  <input id="email_login_f" name="email_login_f" required="required" type="text" placeholder="exemplo@xxxx.com"/>
										</p>
										
										<p> 
										  <label for="senha_login">Senha</label>
										  <input id="senha_login_f" name="senha_login_f" required="required" type="password" placeholder="1234" /> 
										</p>
