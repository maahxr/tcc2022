				...
				<div class="inner">
					...
					<nav>
						<ul>
							...
							<li><a href="servico-cadastrar.php">Cadastro De Serviços</a></li>
							<li><a href="lista-clientes.php">Lista De Serviços</a></li>
			...
			<div id="wrapper">
				...
				<!-- Intro -->
					<section id="intro" class="wrapper style1  fade-up">
						<div class="inner">
							<h1>Bem-Vindo <?php echo $_SESSION['email_login_f'];?></h2></h1>
							<h2>Serviço Imediato Acessivel</h2>
							<p>Pagina para o cadastro de seus serviços. </p>
							<ul class="actions">
										<li><a href="servico-cadastrar.php" class="button">Cadastre aqui</a></li>
									</ul>
						</div>
					</section>
